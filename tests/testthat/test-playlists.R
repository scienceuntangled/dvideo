...
test_that("dv_video_playlist works as expected", {
    ...
    expect_named(px, c("video_src", "start_time", "duration"))
    ...
    px <- dv_video_playlist(x$plays[10, ], x$meta)
    expect_equivalent(px, data.frame(video_src = "myvideo.mp4", start_time = 10-5, duration = 8, stringsAsFactors = FALSE))
    ...
    expect_named(px, c("video_src", "start_time", "duration", "player_name"))
})
